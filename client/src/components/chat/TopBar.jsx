...
const TopBar = ({
  ...
  return (
    <div className="absolute right-2 text-black w-full py-5  bg-transparent z-20 backdrop-blur-xl flex items-center px-5 gap-2 text-lg font-semibold border-b border-gray-700 capitalize">
      <svg
