    ...
    <div className="flex h-full min-h-screen bg-background">
      ...
      <div className="bg-background w-[91%] flex items-center">
        <div className="max-w-xl mx-auto ">
          <h2 className="mb-4 text-2xl font-bold text-black">Update Profile</h2>
            ...
            <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  id="email"
                  disabled
                  className="border text-sm rounded-lg focus:ring-primary-600 block w-full p-2.5 bg-white border-gray-600 placeholder-gray-400 text-gray-400  ring-primary-500 "
